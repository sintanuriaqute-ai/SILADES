...
<html lang="en">
  ...
  <head>
    ...
    <link rel="preload" href="assets/css/boostrap.css" as="style" />
    <style>
  ...
  <body class="sidebar-expand-lg sidebar-open bg-body-tertiary">
                ...
                <a href="#" class="dropdown-item">
                  ...
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1">
                      ...
                      <p class="fs-7">Call me whenever you can assets</p>
      ...
      <aside class="app-sidebar bg-primary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          ...
          <a href="assets/index.html" class="brand-link">
            ...
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-light">Silades</span>
            <!--end::Brand Text-->
          </a>
          <!--end::Brand Link-->
        </div>
        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                <a href="assets/Admin/?page=konfirmasipengajuan" class="nav-link">
            ...
            <li class="nav-item">
               <a href="assets/Admin/?page=verifikasi" class="nav-link">
    ...
    <script src="assetsjs/adminlte.js"></script>
